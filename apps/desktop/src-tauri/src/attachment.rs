//! Rust-Aufrufe von `Shell::open` umgehen den JavaScript-OpenScope; hier liegt die letzte Prüfung vor dem Öffnen.
//! Links müssen bereits normalisiert sein, damit angezeigtes und geöffnetes Ziel übereinstimmen.
//! Bilder bleiben intern. Umleitungsdateien werden abgewiesen; ausführbare Dateien erfordern die Rückfrage der Oberfläche.
//! Bei der Endungsprüfung gelten Windows-Regeln auch auf anderen Plattformen: abschließende Punkte und Leerzeichen entfernen, führende Punkte berücksichtigen.
//! Doppelpunkte im Dateinamen vorher abweisen, da NTFS-Datenströme die Endungsprüfung umgehen können.
