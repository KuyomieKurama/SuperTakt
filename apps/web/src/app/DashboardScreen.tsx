  ...
  return (
    <section className="screen screen--dashboard">
      ...
      */}
      ...
      {/*
        Ein Laufbereich, Name „Dashboard" (T-322 4.1). Fest ist nur der Kopf:
        Die beiden Aktionen sind der Zweck der Ansicht (§12 — „Wichtige
        Aktionen möglichst direkt vom Dashboard aus"). Die Karte „Timer" läuft
        mit, weil der Timer über die Kopfleiste der Anwendung ohnehin **immer**
        sichtbar ist (`TimerBar`); eine zweite dauerhafte Timerfläche wäre die
        Doppelung, die T-065 gerade beseitigt hat. Die Kennzahlkacheln sind der
        Inhalt des Dashboards und nicht seine Steuerung — fest wären sie
