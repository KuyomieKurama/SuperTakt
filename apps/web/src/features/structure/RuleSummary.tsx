 ...
 * Regelverwaltung und als Vorschau im Formular — und zwar **einmal** gebaut.
 * Seit die Regel fünf Achsen hat, wäre eine zweite Fassung nicht mehr bloß
 * uneinheitlich, sondern **falsch**: Eine Spalte, die ausgeschlossene Tags
 * nennt und davon nichts zeigt, behauptet eine Regel, die sie nicht hat.
 *
 * Vorgeschichte: `docs/decisions/structure.md`.
 *
 ...
 *
 * ## Warum die Exportachse kein Buchungsetikett trägt (E-059)
 *
 * Eine Regel ist keine Buchung: Sie **fragt** nach dem Exportstatus ihrer
