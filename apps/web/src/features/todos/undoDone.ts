 ...
 * Board (S-01) und in der Detailansicht (S-03), und an allen dreien mit einem
 * Rückweg samt `catch`: Ein stummer Fehlschlag hätte weder Meldung noch
 * Etikett noch Protokolleintrag, und einen globalen Auffänger für abgewiesene
 * Zusagen gibt es im Baum nicht.
 *
 * *Dieselbe Handlung, zwei Schutzniveaus* lehrt den Benutzer, daß eines davon
 * nichts bedeutet — genau die Begründung, mit der E-059 den Bestätigungsdialog
 * vor „Vom Board nehmen" gestrichen hat. Deshalb steht der Rückweg an allen
 * drei Flächen, und zwar aus **einer** Funktion: Drei Abschriften wären drei
 * Gelegenheiten, die nächste Auflage nur an zweien nachzuziehen.
 *
