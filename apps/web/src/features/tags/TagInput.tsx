...
import { Button, InlineMessage, Spinner, type ControlSize } from "../../shared/ui/Primitives";
 ...
 *
 * Ein Tag wird an vier Stellen gewählt: im Todo-Dialog, in den Standard-Tags,
 * in der Regel eines Pools und als Filter der Todo-Liste. Vier eigene Arten
 * wären für jemanden mit vierzig Tags vier verschiedene Aufgaben.
 *
 * Es ist deshalb eine. Was hier steht, gilt an allen Stellen: dieselbe
 ...
 * (`tagNames`) — wer den Dialog abbricht, hinterlässt kein verwaistes Tag.
 *
