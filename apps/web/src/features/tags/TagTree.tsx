 ...
 *
 * ## Auswaehlen und Aufklappen sind zwei Dinge
 *
 * Umbenennen, Verschieben und Loeschen haengen an der Auswahl. Taeten Klick,
 * Eingabetaste und Leertaste auf einem Knoten **mit Kindern** nur eines —
 * auf- und zuklappen —, waere jeder nicht leere Ordner ueber den Baum nicht zu
 * bearbeiten (A-4.2, A-4.4). Jede einzelne Funktion arbeitete dabei; die Kette
 * braeche trotzdem.
 *
