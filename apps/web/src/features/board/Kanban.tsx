 ...
 * hervorhebt.
 *
 * Der Exportstreifen der Karte steht nicht hier, sondern in
 * `shared/ui/ExportSummaryStrip.tsx`: Er hat zwei Leser außerhalb des Boards.
 *
...
export interface KanbanAppearance {
   ...
   * Regeln, und sie stehen auf der Karte. Ein `readonly string[]` machte die
   * Behandlung an der Anzeigestelle freiwillig, und `scripts/proof-foreign.mjs`
   * könnte sie nicht einfordern. Die Marke sitzt am Element und nicht an der
   * Reihe; der Nachweis liest sie dort (`declaresForeign`).
   */
