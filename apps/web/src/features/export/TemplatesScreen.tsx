...
export function TemplatesScreen({ templateId }: TemplatesScreenProps) {
   ...
   *
   * Zwei Abschriften sind zwei Gelegenheiten, bei der nächsten Änderung eine
   * zu vergessen. Deshalb setzen Liste und Knopf der Standardvorlage die drei
   * Werte nicht selbst, sondern rufen hier an. Vorgeschichte:
   * `docs/decisions/export.md`.
   */
