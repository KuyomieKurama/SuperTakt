...
export interface ExportGroupViewModel {
   ...
   * `"; "` verbunden. Die Marke steht am Feld und nicht erst an der
   * Anzeigestelle — das ist die Zeile, an der ein Benutzer liest, was er
   * gleich abrechnet. Vorgeschichte: `docs/decisions/export.md`.
   */
