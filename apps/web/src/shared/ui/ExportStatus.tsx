 ...
 * addieren.
 *
 * Steht hier und nicht bei einem ihrer beiden Benutzer: Bis T-254 stand die
 * Zeile zeichengleich in `app/exportSummary.ts` (die sie rechnet) und in
 * `shared/ui/ExportSummaryStrip.tsx` (der sie zeigt). Zwei Abschriften
 * derselben Zeile sind zwei Gelegenheiten, bei der naechsten Aenderung eine
 * zu vergessen — und beide fuehren `ExportDisplayState` bereits von hier ein.
 */
