/**
 * Takt — `apps/web/src/features/todos/undoDone.ts` (T-118, B-6/B-7 aus T-116, E-059,
...
vi.mock("../../../src/features/todos/api.ts", () => ({
  clearTodoDone: vi.fn(),
}));

import { clearTodoDone } from "../../../src/features/todos/api.ts";
import { undoDoneAction } from "../../../src/features/todos/undoDone.ts";
import type { ToastApi, ToastInput } from "../../../src/app/ToastContext.ts";
import type { PoolMovement } from "../../../src/api/types.ts";
import type { TodoDoneResult } from "../../../src/features/todos/api.ts";
