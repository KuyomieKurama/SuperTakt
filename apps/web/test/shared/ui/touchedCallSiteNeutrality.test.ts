...
const FORM_DIALOG_FILE = path.resolve(__dirname, "../../../src/shared/ui/FormDialog.tsx");
...
const CONFIRM_DIALOG_FILE = path.resolve(__dirname, "../../../src/shared/ui/ConfirmDialog.tsx");
